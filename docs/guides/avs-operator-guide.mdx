...
Operators that want to quickly deploy a production ready environment using docker and AWS may wish to use the [docker quickstart guide](../operate/validators/docker-quickstart.mdx)
...
You can confirm you are registered on mainnet by entering your address under the `operatorRegistry` function [**here**](https://etherscan.io/address/0x272CF0BB70D3B4f79414E0823B426d2EaFd48910#readProxyContract#F12). Additionally, you can check you are registered on Holesky by checking under the operator's section on EigenLayer's UI for Holesky [here](https://holesky.eigenlayer.xyz/avs/0xc76e477437065093d353b7d56c81ff54d167b0ab).
